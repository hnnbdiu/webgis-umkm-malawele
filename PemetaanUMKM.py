...
/* Bungkus komponen GPS dengan gaya kartu, senada dengan elemen lain.
   Tinggi dikunci di WRAPPER-nya juga (bukan cuma iframe) supaya kebal
   terhadap aturan iframe lain yang mungkin tidak sengaja ikut menimpa. */
...
/* Sembunyikan background putih komponen geolocation + kunci tinggi
   supaya tidak membengkak jadi kotak kosong besar di layar sempit.
   Selector title*="geolocation" dipakai (bukan *="streamlit") supaya
   TIDAK ikut kena aturan iframe lain yang menyasar kata "streamlit". */
