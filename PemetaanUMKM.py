...
/* Bungkus komponen GPS jadi kotak kecil bertema navy. Wrapper INI adalah
   ...
   terlihat navy — bukan hitam kosong/putih polos. */
...
/* Iframe mengisi PENUH wrapper (48x48, tanpa scale/crop berisiko).
   Filter invert() DILEPAS: kemungkinan besar komponen ini sudah otomatis
   memakai gaya gelap sendiri, jadi invert justru membaliknya jadi terang
   (itu sebabnya sempat muncul kotak terang aneh). color-scheme:dark dan
   background transparan tetap dipasang sebagai sinyal ke iframe untuk
   memakai tema gelap bila didukung. */
